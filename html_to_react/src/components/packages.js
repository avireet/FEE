              ...
              <div className="cardpack">
                ...
                <div className="back">
                  <div className="contentpack">
                    ...
                    <button onClick={() => this.handleAddToCart('STARTER PACKAGE', 29.99)}>Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="cardpack">
                ...
                <div className="back">
                  <div className="contentpack">
                    ...
                    <button onClick={() => this.handleAddToCart('ADVANCED PACKAGE', 49.99)}>Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="cardpack">
                ...
                <div className="back">
                  <div className="contentpack">
                    ...
                    <button onClick={() => this.handleAddToCart('PREMIUM PACKAGE', 99.99)}>Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
